...
const JOBS = [
  ...
  { f: 'og-image.png',          html: doc(ogCard('Angelo Boutalikakis &middot; Selected work', 'Angelo Boutalikakis', 'Operator, product builder, and transformation leader.<br>Trained in econometrics.'), DESK) },
